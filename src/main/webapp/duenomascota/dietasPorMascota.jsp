...
<div class="container mt-3 text-center">
    ...
    <a href="${pageContext.request.contextPath}/DietaController?accion=ConsultarMascotas" class="btn btn-secondary">
  ...
  document.addEventListener('DOMContentLoaded', function () {
    ...
    const calendar = new FullCalendar.Calendar(calendarEl, {
      ...
      dateClick: function (info) {
        if (info.dateStr < today) {
          // Usar un modal de alerta más bonito si lo deseas, o mantener alert()
    ...
    document.getElementById('saveEventBtn').addEventListener('click', function() {
        ...
        if (eventTitle) {
            ...
            // Usar un modal de alerta si lo deseas, o mantener alert()
