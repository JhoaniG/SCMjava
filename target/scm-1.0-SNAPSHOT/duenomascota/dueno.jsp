<%-- 
    Document   : dueno
    Created on : 20/06/2025, 11:22:21 a. m.
    Author     : jhoan
--%>
    ...
    <div class="container">
        ...
        <div class="row align-items-center">
            ...
            <div class="col-lg-5 py-4">
                ...
                <a href="404.html" class="btn btn-info font-weight-bold py-2 px-4 mt-2">Saber más</a>
            </div>
        </div>
    </div>
<!--Fin de acerca-->
...
<%@ include file="/modal/registerDiagnostico.jsp" %>
