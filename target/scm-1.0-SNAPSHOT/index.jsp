<%-- 
    Document   : index
    Created on : 20/06/2025, 10:18:23 a. m.
    Author     : jhoan
--%>
...
<header class="header">
  <div class="container-m">
    ...
    <nav class="menu">
      ...
      <button type="button" class="btn btn-info" data-bs-toggle="modal" data-bs-target="#modalRegistro">
  Crear Cuenta
</button>
  ...
  <div id="carouselExampleSlidesOnly" class="carousel slide" data-bs-ride="carousel">
    <div class="carousel-inner">
      <div class="carousel-item active">
        <img src="Imagenes/img1.jpg" class="d-block w-100" alt="Imagen 1">
      </div>
      <div class="carousel-item">
        <img src="Imagenes/img2.jpg" class="d-block w-100" alt="Imagen 2">
      </div>
      <div class="carousel-item">
        <img src="Imagenes//img3.jpg" class="d-block w-100" alt="Imagen 3">
      </div>
    </div>
    <!-- Controles (opcional) -->
    ...
    <div class="row">
      <div class="col-md-4">
        <div class="card border-0">
          <img src="Imagenes/veterinarian1.jpg" class="card-img-top" alt="Dra. Valeria Cruz">
          <div class="card-body">
...
<!--FinTrajetas Nuestras mascotas -->
 ...
 <!-- Contactanos sección -->
<div id="seccion3" class="container mt-5">
  <div class="row align-items-center">
    <!-- Formulario -->
    <div class="col-md-6">
    ...
    <div class="col-md-6 d-none d-md-block">
      <img src="Imagenes/perro.jpg" alt="Contáctanos" class="img-fluid rounded shadow">
    </div>
  </div>
</div>
<!-- Fin Contactanos -->
...
<%@ include file="/modal/registerUsuarioModal.jsp" %>
<!--FIN MENU-->
